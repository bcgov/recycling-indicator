...
* Companies report annually on the amount of recycled material producted and associates cost. [Add links]
...
* The amount of recyled material varied greatly with type of material. The greatest material recycled (kg per person) was packaging and printed paper, while consumable materials ranged from very low (Pharmaceutical)  to high (oil and filters).  

* In general the amount of material recycled increased over time, irrespective of the number of years of data available.  


```{r type vs time all BC, echo = FALSE, warning = FALSE, error = FALSE, message = FALSE, fig.cap = "Recycling per type over time of available data (kgs per person) ", results = 'asis', out.width='0.95\\linewidth', fig.align = 'center'}
