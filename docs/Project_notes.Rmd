...
rdata <- read_csv(paste(data.dir, "bev.csv", sep = "/"), col_types = cols(.default = col_number()))
...
Note these are already calculated per person (assumung the pop data is correct)
...
Used oil is a magnitude differnce in volumne. Repeat graph with out USed oil values: 
